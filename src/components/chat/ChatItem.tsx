    ...
    <>
      ...
      <div
        ...
        className={classNames(
          "group p-2 my-2 flex justify-between gap-3 items-start cursor-pointer rounded-3xl hover:bg-secondary",
      ...
      >
        ...
        >
          <EllipsisVerticalIcon className="h-6 group-hover:w-5 group-hover:opacity-100 w-0 opacity-0 transition-all ease-in-out duration-100 text-zinc-300" />
          <div
            className={classNames(
        ...
        <div className="flex text-white/50 h-full text-sm flex-col justify-between items-end">
          <small className="mb-2 mr-1 inline-flex flex-shrink-0 w-max">
          ...
          {unreadCount <= 0 ? null : (
            <span className="bg-success mr-2 h-2 w-2 aspect-square flex-shrink-0 p-2 text-white text-xs rounded-full inline-flex justify-center items-center">
