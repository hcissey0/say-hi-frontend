      ...
      <Dialog as="div" className="relative z-10" onClose={handleClose}>
        ...
        <div className="fixed mx-auto w-1/2 inset-0 z-10 overflow-y-visible">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel
                className="relative transform overflow-x-hidden rounded-lg bg-dark px-3 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl sm:p-6"
                style={{
                  overflow: "inherit",
                }}
              >
